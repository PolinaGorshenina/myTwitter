...
let module = (function () {
    ...
    function getPosts(skip, top, filterConfig) {
        ...
        if (filterConfig != null) {
            ...
            if(filterConfig.dateFrom != null)
                postsFiltered = postsFiltered.filter(post => post.createdAt >= new Date(filterConfig.dateFrom));
        }
    ...
    function editPost(id, post) {
        ...
        if (!validatePost(module.getPost(id)))
            return false;
        return true;
    }
...
console.log('***   getPosts with tag "dark"   ***');
console.log(module.getPosts(0, 10, {tags: ['dark']}));
console.log('***   getPosts with tag "river"   ***');
console.log(module.getPosts(0, 10, {tags: ['river']}));
console.log('***   getPosts with tag "river" and "forest"   ***');
console.log(module.getPosts(0, 10, {tags: ['river', 'forest']}));
console.log('***   getPosts written by Betty   ***');
console.log(module.getPosts(0, 10, {author: 'Betty'}));
console.log('***   getPosts from 6 May   ***');
console.log(module.getPosts(0, 10, {dateFrom: '2020-05-06'}));
console.log('***   getPost, id = 3   ***');
console.log(module.getPost('3'));
console.log('***   getPost, id = 15   ***');
console.log(module.getPost('15'));
console.log('***   validatePost with wrong username   ***');
console.log(module.validatePost({id: '30',
...
console.log(module.getPost('21'));
console.log('***   edit post   ***');
console.log(module.editPost('5', {description: 'new text'}));
console.log('***   this post:   ***');
console.log(module.getPost('5'));
